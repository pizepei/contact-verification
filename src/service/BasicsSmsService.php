...
class BasicsSmsService
{
     ...
     * @throws \Exception
     */
    public function __construct($appid,$AppsSmsConfigId)
    {
        # 通过appid 获取配置
        ...
        # 获取通道配置
        $this->AppsSmsConfig =  AppsSmsConfigModel::table()->cache(['Microservice:AppsSmsConfig',$appid],120)->get($AppsSmsConfigId);
